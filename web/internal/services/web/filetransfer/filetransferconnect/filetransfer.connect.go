...
import (
	...
	context "context"
	errors "errors"
	filetransfer "github.com/itsrobel/sync/web/internal/services/web/filetransfer"
	http "net/http"
	strings "strings"
)
...
func NewFileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FileServiceClient {
	...
	fileServiceMethods := filetransfer.File_web_filetransfer_filetransfer_proto.Services().ByName("FileService").Methods()
